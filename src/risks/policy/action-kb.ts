...
export const ACTION_KB: Record<string, ActionKbEntry[]> = {
  new_device_login: [
    {
      ...
      cardNews: { emoji: '🔑', title: '비밀번호 하나 뚫리면 어디까지 털릴까?\n3분이면 끝나는 재사용 끊기', ctaLabel: '카드뉴스 ↗', url: 'https://www.instagram.com/idly__apt/', badge: '카드뉴스' },
    ...
    },
    {
      ...
      cardNews: { emoji: '🔒', title: '로그아웃만으로 충분할까?\n세션 보안 완벽 체크리스트', ctaLabel: '확인하기 ↗', url: 'https://www.instagram.com/idly__apt/', badge: '카드뉴스' },
    ...
    },
    {
      ...
      required: false,
      officialUrlKind: 'security',
      cardNews: { emoji: '🛡️', title: 'Google Authenticator vs Authy\n내 상황엔 어떤 게 맞을까?', ctaLabel: '비교하기 ↗', url: 'https://www.instagram.com/idly__apt/', badge: '카드뉴스' },
  ...
  security_recommendation: [
    ...
    },
    {
      ...
      required: false,
      officialUrlKind: 'security',
      cardNews: { emoji: '🛡️', title: '2단계 인증, 어떻게 설정하나요?\n5분이면 충분한 설정 가이드', ctaLabel: '가이드 ↗', url: 'https://www.instagram.com/idly__apt/', badge: '카드뉴스' },
