...
- \`notificationAgreed\`: 실시간 보안 알림 수신 동의 (선택) — 생략 시 false, 미동의 시 알림 발송 안 됨
- \`marketingAgreed\`: 마케팅 정보 수신 동의 (선택) — 생략 시 false`,
  })
...
**응답 포함 정보**
- \`id\`, \`name\`, \`phone\`, \`ageGroup\`, \`notificationAgreed\`, \`marketingAgreed\`
