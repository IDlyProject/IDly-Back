...
2. `POST .../messages` — `action_select` | `feedback` | `failure_reason` (Phase1: 자유 `user_text` 미지원)
...
| `failure_reason` | ✅ |
| `user_text` (자유 질문 + Solar) | ❌ Phase1 미지원 — 동일 400 메시지 유지 |
